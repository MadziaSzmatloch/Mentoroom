...
namespace Mentoroom.INFRASTRACTURE.Migrations
{
    ...
    [Migration("20240417014941_updatedClassName")]
    partial class updatedClassName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mentoroom.DOMAIN.Entities.Admin.LecturersAccessCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mentoroom.DOMAIN.Entities.Shared.Course", b =>
                {
                    ...
                    b.HasOne("Mentoroom.DOMAIN.Entities.Tags.Major", "Major")
                        .WithMany("Courses")
                        .HasForeignKey("MajorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mentoroom.DOMAIN.Entities.Tags.Semester", "Semester")
                        .WithMany("Courses")

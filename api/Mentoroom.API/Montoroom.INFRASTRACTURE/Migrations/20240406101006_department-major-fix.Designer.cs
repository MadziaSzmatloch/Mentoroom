...
namespace Mentoroom.INFRASTRACTURE.Migrations
{
    ...
    [Migration("20240406101006_department-major-fix")]
    partial class departmentmajorfix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mentoroom.DOMAIN.Entities.Attributes.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mentoroom.DOMAIN.Entities.Attributes.Major", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Mentoroom.DOMAIN.Entities.LecutrerModels.Lecturer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseLecturer", b =>
                {
                    b.HasOne("Mentoroom.DOMAIN.Entities.LecutrerModels.Lecturer", null)
                        .WithMany()
                        .HasForeignKey("AuthorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mentoroom.DOMAIN.Entities.Shared.Course", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Mentoroom.DOMAIN.Entities.Shared.Course", b =>
                {
                    b.HasOne("Mentoroom.DOMAIN.Entities.Attributes.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mentoroom.DOMAIN.Entities.Attributes.Major", "Major")
                        .WithMany()
